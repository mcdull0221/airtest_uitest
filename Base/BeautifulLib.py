...
class DIYReportTestResult(ReportTestResult):
    ...
    def get_testcase_property(test) -> tuple:
        ...
        return class_name, method_name, method_doc, html_path
    ...
    def stopTest(self, test) -> None:
        ...
        :return:
        """
        self.end_time = '{0:.3f} s'.format((time.time() - self.start_time))
...
if __name__ == '__main__':
    ...
    print(start_time)
    stop_time = start_time - 400
    end_time = '{0:.3f} s'.format((start_time - stop_time))
    print(end_time)
